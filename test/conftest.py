...
def pytest_configure(config):
    def check_for_full_model():
        ...
        if not os.path.exists(new_file):
            ...
            # slug/payload limit. Therefore, using this alternative to get it
            # from Github during runtime.
            if not os.path.exists(first_file):
                ...
                filename = wget.download(
                    url1, out='source/punct_model_part1.pcl')
            ...
            if not os.path.exists(second_file):
                ...
                filename = wget.download(
                    url2, out='source/punct_model_part2.pcl')
                print("\nDownloaded file: " + filename)
            ...
            if not os.path.exists(third_file):
                ...
                filename = wget.download(
                    url3, out='source/punct_model_part3.pcl')
                print("\nDownloaded file: " + filename)
